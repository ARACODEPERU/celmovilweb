                ...
                <div class="col-sm-6">
                    <div class="right">
                        <div class="singl-pro-title">
                            ...
                            @if ($product->category_description == 'Vmps, Bicimotos, Bios' || $product->category_description == 'Trimoto' || $product->category_description == 'Cuatrimotos' || $product->category_description == 'Moto' || $product->category_description == 'Scooter Moped' || $product->category_description == 'Deportivos' || $product->category_description == 'Chooper' || $product->category_description == 'Baterias Litio' || $product->category_description == 'Baterias Plomo Acido' || $product->category_description == 'Scooter Vintage' || $product->category_description == 'Vmps, Bicimotos, Bicis')
                                 @endif
                            <hr />
                            {!! $product->description !!}
                            <br>
