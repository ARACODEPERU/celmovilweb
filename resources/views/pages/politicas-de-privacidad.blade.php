                    ...
                    <div class="col-md-12 wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                        <div class="about-two__text-box">
                            ...
                            <p class="about-two__text-box-text">
                                En [Nombre de tu Empresa/Sitio Web] (en adelante, "nosotros", "nuestro" o "la empresa"), estamos comprometidos 
                                con la protección de tu privacidad y la seguridad de la información personal que compartes con nosotros. 
                                Esta Política de Privacidad explica cómo recopilamos, usamos, y protegemos tu información personal 
                                cuando visitas nuestro sitio web [URL del sitio web] y realizas compras de nuestras motos eléctricas.
                            </p>
                            <br>
                            ...
                            <p class="about-two__text-box-text">
                                ...
                                responder a solicitudes legales, o proteger los derechos, propiedad o seguridad de [Nombre de tu 
                                Empresa/Sitio Web], nuestros clientes u otros.
                            </p>
                            <p class="about-two__text-box-text">
                            ...
                            <p class="about-two__text-box-text">
                                ...
                                tu información personal, no dudes en contactarnos a través de [Dirección de correo electrónico 
                                de contacto] o [Dirección física de la empresa, si aplica].
                            </p>
                        </div>
                    </div>
                </div>
