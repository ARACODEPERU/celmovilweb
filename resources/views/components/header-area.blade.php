<div>
    ...
    <div class="top-bar">
        <div class="container">
            <div class="top-bar-left">
                <a href="tel:+51999999999"><i class="fa fa-phone"></i> (+51) 910325038 | (+51) 921197459</a>
                                            ...
                                            <div class="mega-menu-list">
                                                ...
                                                <ul>
                                                    @foreach ($category->subcategories as $subcategory)
                                                        <li>
                                                            <a
                                                                href="{{ route('web_producto_principal', $subcategory->id) }}">
    ...
    <style>
        ...
        body.dark #main-header.scrolled .nav-menu>li>a {
            color: white;
        }
        ...
        body.dark #main-header.scrolled .icon-btn {
            color: white;
        }
        ...
        @media (max-width: 991px) {
            ...
            #main-header.scrolled .mobile-menu-trigger {
                color: #ffffff;
            }

            body.dark #main-header.scrolled .mobile-menu-trigger {
                color: white;
            }
        }
